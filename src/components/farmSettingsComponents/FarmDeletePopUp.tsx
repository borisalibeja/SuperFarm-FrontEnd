...
interface FarmDeletePopupProps {
  isOpen: boolean;
  onClose: () => void;
  onDelete: (reason: string) => void;
}

const FarmDeletePopup: React.FC<FarmDeletePopupProps> = ({
  isOpen,
  onClose,
  onDelete,
}) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
      <div className="bg-gray-700 w-96 p-6 rounded-lg shadow-lg text-black flex flex-col justify-between">
        ...
        <div className="flex justify-center text-white items-center mb-4">
          <h2 className="text-2xl font-bold">Delete Farm Account</h2>
        </div>
...
export default FarmDeletePopup;
