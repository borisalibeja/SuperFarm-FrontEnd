        ...
        <div className="flex flex-1 flex-col"> 
          <nav className="w-full bg-black border-b-[0.5px] border-gray-600 text-white">
            <div className="flex text-xl justify-center gap-x-15 py-4 px-10">
              ...
              <Link to="/profile/addresses" className="font-semibold  hover:underline">
                Addresses
              </Link>
              <Link to="/profile/settings" className="font-semibold  hover:underline">
                Settings
              </Link>
              <Link to="/profile/help" className="font-semibold  hover:underline">
                Help
              </Link>
            </div>
          </nav>
